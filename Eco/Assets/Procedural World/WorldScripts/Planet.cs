...
public class Planet : MonoBehaviour
{
    ...
    public void OnShapeSettinsUpdated()
    {
        if (autoUpdate)
        {
            InitializeMeshFilters();
    ...
    void GenerateMesh()
    {
        foreach (TerrainFace _face in terrainFaces)
        {
            _face.ConstructMesh();
        }
    }
    ...
    void GenerateColours()
    {
        ...
        {
            _meshFilter.GetComponent<MeshRenderer>().sharedMaterial.color = colourSettings.planetColour;
        }
    }
}