...
public class TerrainGenerator : MonoBehaviour
{
    ...
    public void DrawMapInEditor()
    {
        ...
        {
            terrainDisplay.DrawMesh(MeshGenerator.GenerateTerrainMesh(mapData.heightMap, meshHeightMultiplier, meshHeightCurve, levelOfDetail), TextureGenerator.TextureFromColourMap(mapData.colourMap, mapChunkSize, mapChunkSize));
        }
    }
